                ...
                <div className={styles['single-card']}>
                    ...
                    <div className={styles['single-card__info']}>
                        <div className={styles['single-card__header-info']}>
                            <h1 className={styles['single-card__title']}>
                                {name}
                            </h1>
                            <div className={styles.btnsBox}>
                                <Button
                                    ...
                                    className={cn(
                                        styles['single-card__save-button']
                                    )}
                                ...
                                {authContext && (
                                    <>
                                        <Button
                                            ...
                                            className={cn(
                                                styles[
                                                    'single-card__save-button'
                                                ],
                                                {
                                                    [styles[
                                                        'single-card__save-button_active'
                                                    ]]: is_favorited,
                                                }
                                            )}
                        ...
                        <div className={styles['single-card__extra-info']}>
                            ...
                            <p
                                className={
                                    styles['single-card__text_with_link']
                                }
                            >
                                <div className={styles['single-card__text']}>
                                    <div
                                        className={
                                            styles['single-card__user-avatar']
                                        }
                                        style={{
                                    ...
                                    <>
                                        <Button
                                            className={cn(
                                                ...
                                                styles[
                                                    'single-card__button_add-user'
                                                ],
                                                {
                                                    [styles[
                                                        'single-card__button_add-user_active'
                            ...
                            {authContext && (
                                <Button
                                    className={cn(
                                        styles['single-card__button'],
                                        styles[
                                            'single-card__button_add-receipt'
                                        ]
                                    )}
                                    modifier="style_dark"
                                    clickHandler={_ => {
