...
const RecipeEdit = ({ onItemDelete }) => {
    ...
    const handleAddIngredient = () => {
        ...
        if (
            recipeIngredients.find(({ name }) => name === ingredientValue.name)
        ) {
    ...
    useEffect(
        _ => {
            ...
            api.getIngredients({ name: ingredientValue.name }).then(
                ingredients => {
        ...
        <Main>
            <Container>
                <Helmet>
                    ...
                    <meta
                        name="description"
                        content="Фудграм - Редактирование рецепта"
                    />
                    <meta
                        property="og:title"
                        content="Редактирование рецепта"
                    />
                </Helmet>
                ...
                <Form
                    ...
                    onSubmit={e => {
                        ...
                        api.updateRecipe(data, recipeFileWasManuallyChanged)
                            .then(res => {
                            ...
                            {recipeIngredients.map(item => {
                                return (
                                    ...
                                    >
                                        <span
                                            className={
                                                styles.ingredientsAddedItemTitle
                                            }
                                        >
                                            {item.name}
                                        </span>{' '}
                                        ...
                                        <span
                                            className={
                                                styles.ingredientsAddedItemRemove
                                            }
                                            onClick={_ => {
